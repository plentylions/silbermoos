...
{
    protected $template = 'Silbermoos::Widgets.Header.NavigationWidget';
    ...
    {
        return WidgetDataFactory::make('Silbermoos::NavigationWidget')
    ...
    public function getSettings()
    {
        ...
        $settingsFactory->createCheckbox('limitRootItems')
            ->withName('Widget.navigationLimitRootItemsLabel')
            ->withDefaultValue(false);

        $settingsFactory->createNumber('maxRootItems')
            ->withName('Widget.navigationMaxRootItemsLabel')
            ->withTooltip('Widget.navigationMaxRootItemsLabel')
            ->withDefaultValue(4)
            ->withCondition('limitRootItems');
